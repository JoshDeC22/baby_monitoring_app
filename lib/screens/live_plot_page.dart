// live_plot_page.dart
import 'package:baby_monitoring_app/colors.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
            child: GraphWidget(number: 1, paramName: 'glucose', data: glucoseData, lineColor: Colors.green),
          ),
          Expanded(
            child: GraphWidget(number: 2, paramName: 'lactate', data: lactateData, lineColor: Colors.red),
          ),
        ],
      ),
    );
